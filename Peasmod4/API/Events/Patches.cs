...
public class Patches
{
    ...
    {
        MeetingEventManager.MeetingEndEventHandler?.Invoke(null,
            new MeetingEventManager.MeetingEndEventArgs(exiled, tie));
    }
    ...
    public static void GameEndPatch() //([HarmonyArgument(0)] EndGameResult result)
    {
        ...
        GameEventManager.GameEndEventHandler?.Invoke(null,
            new GameEventManager.GameEndEventArgs(EndGameResult.CachedGameOverReason));
    }
    ...
    {
        HudEventManager.HudSetActiveEventHandler?.Invoke(null,
            new HudEventManager.HudSetActiveEventArgs(__instance, isActive));
    }
    ...
    {
        PlayerEventManager.PlayerExiledEventHandler?.Invoke(null,
            new PlayerEventManager.PlayerExiledEventArgs(__instance));
    }
    ...
    public static void PlayerMurderedPatch(PlayerControl __instance, [HarmonyArgument(0)] PlayerControl victim,
        [HarmonyArgument(1)] MurderResultFlags flags)
    {
        PlayerEventManager.PlayerMurderedEventHandler?.Invoke(null,
            new PlayerEventManager.PlayerMurderedEventArgs(__instance, victim, flags));
    }
    ...
    {
        PlayerEventManager.PlayerCompletedTaskEventHandler?.Invoke(null,
            new PlayerEventManager.PlayerCompletedTaskEventArgs(player,
                player.myTasks.WrapToSystem().Find(t => t.Id == id)));
    }
